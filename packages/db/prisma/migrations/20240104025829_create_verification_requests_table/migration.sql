/*
  ...
  - Added the required column `banned_at` to the `users` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "users" ADD COLUMN     "banned_at" TIMESTAMP(3) NOT NULL;
...
-- CreateIndex
CREATE UNIQUE INDEX "verify_requests_user_id_key" ON "verify_requests"("user_id");
